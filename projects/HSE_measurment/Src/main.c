...
//to turn on the HSE in the RCC block , use RCC clock control register (RCC_CR)
//set bit 16 to 1
...
int main(void)
{
	...
	//turn on HSE by setting bit 16 to 1
	uint32_t *pRccCrReg =  (uint32_t*) RCC_CR_REG_ADDR;
	*pRccCrReg |= (1<<16);

	//make sure HSE is ready by checking if bit 17 of same register is 1
